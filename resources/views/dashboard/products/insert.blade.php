        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <!-- Horizontal Form -->
                  <form action="{{ url('/ProductsStore') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Image</label>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputText" value="{{ old('Price') }}" name="Price">
                          @error('Price')
                                  <p class="text-danger">{{ $message }}</p>
                              @enderror
                        </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputText" value="{{ old('Status') }}" name="Status">
                          @error('Status')
                                  <p class="text-danger">{{ $message }}</p>
                              @enderror
                        </div>
                      ...
                      <div class="col-12">
                        <select name="CategoryID" id="" class="form-select mb-3">
                            @foreach ($Service as $sr)
                                {{-- <option value="0" selected>Select SubServices</option> --}}
